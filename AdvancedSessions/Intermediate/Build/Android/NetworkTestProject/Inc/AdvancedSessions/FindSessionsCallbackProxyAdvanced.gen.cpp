...
// End Cross Module References
	...
	UFunction* Z_Construct_UFunction_UFindSessionsCallbackProxyAdvanced_FindSessionsAdvanced()
	{
		...
		if (!ReturnFunction)
		{
			...
			static const UE4CodeGen_Private::FIntPropertyParams NewProp_HostSessionAddr = { UE4CodeGen_Private::EPropertyClass::Int, "HostSessionAddr", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000080, 1, nullptr, STRUCT_OFFSET(FindSessionsCallbackProxyAdvanced_eventFindSessionsAdvanced_Parms, HostSessionAddr), METADATA_PARAMS(nullptr, 0) };
	...
	UClass* Z_Construct_UClass_UFindSessionsCallbackProxyAdvanced()
	{
		...
		if (!OuterClass)
		{
			...
			static const FClassFunctionLinkInfo FuncInfo[] = {
				...
				{ &Z_Construct_UFunction_UFindSessionsCallbackProxyAdvanced_FindSessionsAdvanced, "FindSessionsAdvanced" }, // 3796326632
			};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UFindSessionsCallbackProxyAdvanced, 997339295);
