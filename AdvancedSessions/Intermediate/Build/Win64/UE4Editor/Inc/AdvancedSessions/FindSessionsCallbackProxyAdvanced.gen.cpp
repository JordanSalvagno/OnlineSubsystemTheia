...
// End Cross Module References
	...
	UFunction* Z_Construct_UFunction_UFindSessionsCallbackProxyAdvanced_FindSessionsAdvanced()
	{
		...
		if (!ReturnFunction)
		{
			...
			static const UE4CodeGen_Private::FStructPropertyParams NewProp_Filters_Inner = { UE4CodeGen_Private::EPropertyClass::Struct, "Filters", RF_Public|RF_Transient|RF_MarkAsNative, 0x0000000000000000, 1, nullptr, 0, Z_Construct_UScriptStruct_FSessionsSearchSetting, METADATA_PARAMS(nullptr, 0) };
			static const UE4CodeGen_Private::FIntPropertyParams NewProp_HostSessionPort = { UE4CodeGen_Private::EPropertyClass::Int, "HostSessionPort", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000080, 1, nullptr, STRUCT_OFFSET(FindSessionsCallbackProxyAdvanced_eventFindSessionsAdvanced_Parms, HostSessionPort), METADATA_PARAMS(nullptr, 0) };
			static const UE4CodeGen_Private::FStrPropertyParams NewProp_HostSessionAddr = { UE4CodeGen_Private::EPropertyClass::Str, "HostSessionAddr", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000080, 1, nullptr, STRUCT_OFFSET(FindSessionsCallbackProxyAdvanced_eventFindSessionsAdvanced_Parms, HostSessionAddr), METADATA_PARAMS(nullptr, 0) };
			...
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				...
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_Filters,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_Filters_Inner,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_HostSessionPort,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_HostSessionAddr,
	...
	UClass* Z_Construct_UClass_UFindSessionsCallbackProxyAdvanced()
	{
		...
		if (!OuterClass)
		{
			...
			static const FClassFunctionLinkInfo FuncInfo[] = {
				...
				{ &Z_Construct_UFunction_UFindSessionsCallbackProxyAdvanced_FindSessionsAdvanced, "FindSessionsAdvanced" }, // 3444753289
			};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UFindSessionsCallbackProxyAdvanced, 194393612);
